...
bl_info = {
    ...
    "version"  : (1, 0),
    "blender"  : (2, 82, 0),
    "warning"  : 'Trial addon, working on more. Instagram - @vibhorguptapresents .Thank You',
    "location" : "VIEW_3D > Tools",
    "wiki_url" : "https://github.com/Codelito/WireLink.git"
...
class WireLink_OT(bpy.types.Operator):
    ...
    def execute(self,context):
        ...
        def Generate_Points(oblist):
            ...
            ps[0].settings.use_emit_random = False 
